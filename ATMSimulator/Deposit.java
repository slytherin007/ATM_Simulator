...
public class Deposit extends JFrame{	
	...
	Color col2=new Color(246, 185, 59);//button
	Color col3=new Color(50, 240, 20);//label
...
Deposit(){
	...
	ResultSet rs=stm.executeQuery("select * from boring_bank.account_details where Pin='"+s2+"'");
	long balance=0;
	if(rs.next()) {
		...
		long d=s1;
		balance+=d;
		String str="Update boring_bank.account_details set Deposit='"+d+"',Balance='"+balance+"' where Pin='"+pin+"'";
	...
	Color c=new Color(10, 61, 98);//backgroung color
