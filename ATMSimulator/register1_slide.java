...
class register1 extends JFrame{
	...
	Color col4=new Color(10, 61, 98);//background radio
	...
	register1(){
		...
		PreparedStatement pst =con.prepareStatement("insert into boring_bank.personal_details(FirstName,MiddleName,LastName,Address,City,Pincode,State,Dob,Gender,MaritalStatus) "
				+ "values(?,?,?,?,?,?,?,?,?,?)");
