...
class register2_slide extends JFrame{
	...
	Color c=new Color(10, 61, 98);//background radio
	...
	jbt1.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			try {			
				...
				PreparedStatement pst=con.prepareStatement("insert into boring_bank.account_details(Account_Type,EmailId,Cardnumber,Pin,Deposit,Balance,Withdraw)"
						+ "values(?,?,?,?,?,?,?)");
